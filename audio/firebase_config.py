...
try:
    ...
    firebase_app = firebase_admin.get_app("audio")
except ValueError:
    ...
    if not os.path.exists(service_account_path):
        ...
        service_account_path = os.path.join(
            parent_dir, "audio", "learn-pal-firebase-adminsdk-ugedp-fcb865a7d8.json"
        )
        if not os.path.exists(service_account_path):
            print(
    ...
    firebase_app = firebase_admin.initialize_app(cred, name="audio")
